...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
     ...
     * 1. Our time intraval should have passed
     * 2. The lottery should have  atleast have 1 player and have some ETH
     * 3. Our subscription should be in an "open" state.
     */
